    ...
    def __init__(
        ...
        for s in self.states:
            ...
            if s > 0:
                ...
                prl = rightProbaLeft
            li.append((1.0 - prr - prl, s, False))
            self.transitions[s][0][s] = 1.0 - prr - prl

            self.P[s][1] = []  # 0=right", 1=left
            self.transitions[s][1] = {}
            li = self.P[s][1]
            if s > 0:
                li.append((1.0, s - 1, False))
                self.transitions[s][1][s - 1] = 1.0
            else:
                li.append((1.0, s, False))
                self.transitions[s][1][s] = 1.0
...
class ErgodicRiverSwim(DiscreteMDP):
    def __init__(
        ...
        for s in self.states:
            ...
            pll = 0.0
            if s > 0:
                li.append((1.0 - ergodic, s - 1, False))
                self.transitions[s][1][s - 1] = 1.0 - ergodic
                pll = 1.0 - ergodic
            if s < self.nS - 1:
                li.append((ergodic / 2, s + 1, False))
                self.transitions[s][0][s + 1] = ergodic / 2
                plr = ergodic / 2
            li.append((1.0 - plr - pll, s, False))
            self.transitions[s][0][s] = 1.0 - plr - pll
        ...
        super(ErgodicRiverSwim, self).__init__(
            self.nS,
            self.nA,
            self.P,
            self.rewards,
